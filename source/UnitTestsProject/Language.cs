...
public class LanguageSemantic
    ...
    public void ConvertCharListToAsciiList_Test()
        ...
        string testingFilePath = "/Users/chaitrabhandari/Desktop/filename.txt";
        ...
        List<double> expectedAsciiValues = new List<double> { 84, 104, 101, 32, 116, 101, 115, 116, 32, 100, 97, 116, 97 };
    ...
    public void Predictor_PredictNextElement_ReturnsCorrectPrediction()
        ...
        foreach (char c in testingData)
            ...
            RunLanguageSemanticExperiment experiment = new RunMultiSequenceLearningExperiment();
    ...
    public void TestBinaryCrossEntropyCalculation()
        ...
        foreach (var predictedSet in predictedSets)
            {
            bce = RunMultiSequenceLearningExperiment.CalculateBinaryCrossEntropy(actualOutputs, predictedSet, threshold);
        ...
        // ensuring BCE is non-negative
        Assert.IsTrue(totalBCE >= 0);
